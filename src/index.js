...
//jsp나 spring에서 header, footer를 미리 만들어놓고 필요한 부분에 로딩하는
//사용하는 것과 동일한 형태

// JSX : html과 js가 합해진 형태의 문법
//화면을 그리기위한 소스코드를 전부 순수 자바스크립트로 생성하기에는 힘들게 때문에 
//JS + XML로 이루어진 JSX라는 문법을 사용하여 html화면을 쉽게 구성함

// PROP : 각 컴포넌트끼리 데이터를 주고 받기 위한 객체,일종의 매개변수
root.render(
  <React.StrictMode>
